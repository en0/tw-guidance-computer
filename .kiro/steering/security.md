...
- Player credentials or the contents of `~/traidwars/creds`
- Raw session log content that includes the SSH connection handshake or login flow

## When Quoting Session Logs

Session logs at `~/traidwars/sessions/` contain sensitive data. When writing to the knowledge base or any committed file:
